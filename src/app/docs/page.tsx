...
const CodeBlock = ({ code, language }: { code: string; language: string }) => {
  ...
  return (
    <div className="bg-slate-900 rounded-xl overflow-hidden shadow-sm my-6 border border-slate-800 w-full max-w-full">
      <div className="flex items-center justify-between px-4 py-2.5 bg-slate-800/50 border-b border-slate-800">
        ...
        <button onClick={handleCopy} className="text-slate-400 hover:text-white transition-colors flex items-center gap-1.5 bg-slate-800 px-2.5 py-1 rounded-md border border-slate-700 hover:border-slate-500 flex-shrink-0">
          {copied ? (
      ...
      <div className="p-4 overflow-x-auto scrollbar-hide w-full">
        <pre className="text-sm text-emerald-400 font-mono whitespace-pre leading-relaxed inline-block min-w-full">{code.trim()}</pre>
      </div>
    </div>
  );
};
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-emerald-100 flex flex-col overflow-x-hidden w-full">
      ...
      <div className="flex max-w-7xl mx-auto w-full flex-1">
        ...
        <main className="flex-1 min-w-0 px-6 py-12 md:px-12 max-w-4xl pb-32 w-full">
          ...
          <div className="mb-12">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-6 break-words">ANCI API Documentation</h1>
          ...
          <section id="create-session" className="mb-16 pt-8 border-t border-slate-200">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-3 flex items-center gap-3">
              ...
              <span className="break-all">/api/sessions/create</span>
            </h3>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 overflow-x-auto w-full">
              <ul className="space-y-4 text-slate-600 font-medium text-sm md:text-base">
                ...
                <li className="flex flex-col md:flex-row md:items-start gap-1 md:gap-3">
                  ...
                  <span>API credit limit reached. Please upgrade your plan.</span>
                </li>
                <li className="flex flex-col md:flex-row md:items-start gap-1 md:gap-3">
          ...
          <section id="widget" className="mb-16 pt-8 border-t border-slate-200">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Pass your generated `sessionId` to the embedded iframe to start the chat. The iframe is naturally responsive and will expand to fill the width of its container.
            </p>
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              When the AI and the customer successfully agree on a price, the iframe emits a standard browser `postMessage` event containing the strict JSON payload below. Listen for this event to retrieve the final negotiated price and proceed with checkout.
            </p>
